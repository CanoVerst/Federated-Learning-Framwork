...
def get_target_lr_scheduler(stage_prefix: None):
    """ Get a lr_scheduler based on the required prefix that defines the specific stage,
...
def get(optimizer: optim.Optimizer, iterations_per_epoch: int,
    ...
    _scheduler, lr_params = get_target_lr_scheduler(stage_prefix)
